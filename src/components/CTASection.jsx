...
export default function CTASection() {
  ...
  return (
    <section className="relative z-10 flex h-svh min-h-[680px] flex-col items-stretch justify-center bg-gradient-to-br from-[#1D4ED8] to-[#1E40AF] md:overflow-hidden snap-start">
      ...
      <div className="relative z-10 mx-auto w-full px-5 lg:max-w-[1122px] lg:px-4">
        <div className="w-full" ref={ref}>
          <h2
            className={`inline-block whitespace-pre-wrap break-words text-center text-white text-[58px] leading-[1.2] md:leading-[165px] tracking-[-0.5px] font-helvetica transition-all duration-1000 ${
          ...
          <div className="flex flex-wrap items-end justify-between">
            <p
              className={`text-[32px] text-blue-100 md:text-[40px] xl:text-[52px] font-helvetica whitespace-pre-line transition-all duration-1000 delay-200 ${
            ...
            >
              {lang === 'ID' ? (
                <>
                  <span>Untuk </span>
                  <i className="font-ramillas italic">Semua </i>
                  <span>Kebu<i className="font-ramillas italic">tuh</i>an </span>
                  <br className="hidden md:block" />
                  <span className="font-bold text-[#BFDBFE]">Pemasaran Anda.</span>
                </>
              ) : (
                <>
                  <span>To </span>
                  ...
                  <br className="hidden md:block" />
                  <span className="font-bold text-[#BFDBFE]">Marketing Needs.</span>
                </>
              )}
            </p>
            <div
            ...
            >
              <Link
                href="/contact-us"
                className="animated-link inline-flex rounded-lg bg-white text-[#1A56DB] hover:bg-[#EBF5FF] transition-all border-0"
              >
                ...
                <div className="icon-wrapper h-[38px] md:h-[49px] aspect-[1/1] overflow-hidden flex items-center justify-end bg-[#1A56DB] rounded-lg">
                  <div className="flex gap-3 px-3 icon text-white">
